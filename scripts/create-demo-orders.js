...
const DEMO_CUSTOMER_BILLING_CITY = process.env.DEMO_CUSTOMER_BILLING_CITY || 'Rochdale'
const DEMO_CUSTOMER_BILLING_POSTCODE = process.env.DEMO_CUSTOMER_BILLING_POSTCODE || 'OL11 1AA'
...
const DEMO_CUSTOMER_PHONE = process.env.DEMO_CUSTOMER_PHONE || '01706 000000'
